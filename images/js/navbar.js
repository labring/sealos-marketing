              ...
              <div id="tool-content" class="tool-content1">
                <div id="tool1" class="tool-item active">
                  <div class="menu-right">
                    ...
                    <div class="menu-more">查看更多<img src="./images/img/ico-jt.svg" alt="更多"></div>
                  </div>
                  <div class="list-gj1">
                    <ul>
                     <a href="../alist"> <li> <img src="./images/img/Alist.svg" class="list-gijtitleico">
                      ...
                      <a href="../affine"><li> <img src="./images/img/favicon-144.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Affine</h2>
                     ...
                     <a href="../headscale"> <li> <img src="./images/img/headscale3-dots.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Headscale</h2>
                      ...
                      <a href="../deeplx"><li> <img src="./images/img/DeeplX.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>DeeplX</h2>
                    ...
                    <ul>
                      <a href="../Vaultwarden"><li> <img src="./images/img/vaultwarden-icon.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Vaultwarden</h2>
                     ...
                     <a href="../kuboard"> <li> <img src="./images/img/favicon.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>kuboard</h2>
                      ...
                      <a href="../blossom"><li> <img src="./images/img/141598483.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>blossom</h2>
                     ...
                     <a href="../code-server"> <li> <img src="./images/img/favicon11.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>code-server</h2>
                ...
                <div id="ai" class="tool-item">
                  ...
                  <div class="list-gj1">
                    <ul>
                      <a href="../chatgpt-next-web"><li> <img src="./images/img/iconchatgpt.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                      ...
                      <a href="../fastgpt"><li> <img src="./images/img/fastgpt.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>FastGPT  🔥</h2>
                     ...
                     <a href="../chatgpt-on-wechat"> <li> <img src="./images/img/26161723.jpeg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                      ...
                      <a href="../chatgpt-web"><li> <img src="./images/img/chat-web.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Chatgpt-Web</h2>
                    ...
                    <ul>
                      <a href="../chatgpt-midjourney"><li> <img src="./images/img/chatmidjourney.ico" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                      ...
                      <a href="../gpt-academic"><li> <img src="./images/img/chatacademic.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Gpt-Academic</h2>
                     ...
                     <a href="../librechat"> <li> <img src="./images/img/librechat.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>LibreChat</h2>
                     ...
                     <a href="../one-api"> <li> <img src="./images/img/oneapi.ico" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>One-api 🔥</h2>
                ...
                <div id="sjk" class="tool-item">
                  ...
                  <div class="list-gj1">
                    <ul>
                     <a href="../teable"> <li> <img src="./images/img/x9gZmjwbtvaGd95qbfUmsZ8Jc.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Teable</h2>
                     ...
                     <a href="../pgadmin4"> <li> <img src="./images/img/logo-128.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Pgadmin4</h2>
                      ...
                      <a href="../nocodb"><li> <img src="./images/img/nocodb-logo.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>NocoDB</h2>
                      ...
                      <a href="../redisInsight"><li> <img src="./images/img/redisinsight.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>RedisInsight</h2>
                    ...
                    <ul>
                      <a href="../influxdb"><li> <img src="./images/img/5713248.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Influxdb</h2>
                     ...
                     <a href="../bytebase"> <li> <img src="./images/img/bytebase.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Bytebase</h2>
                     ...
                     <a href="../dataease"> <li> <img src="./images/img/DataEase.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>DataEase</h2>
                     ...
                     <a href="../metabase"> <li> <img src="./images/img/metabase.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Metabase</h2>
                            <div class="list-bsrs"><img src="./images/img/Icon (Stroke).svg">+38.6k</div>
                ...
                <div id="ddm" class="tool-item">
                  ...
                  <div class="list-gj1">
                    <ul>
                     <a href="../appsmith"> <li> <img src="./images/img/Appsmith.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Appsmith</h2>
                      ...
                      <a href="../pageplug"><li> <img src="./images/img/PagePlug.ico" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>PagePlug</h2>
                      ...
                      <a href="../fireboom"><li> <img src="./images/img/Fireboom.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Fireboom</h2>
                      ...
                      <a href="../illabuilder"><li> <img src="./images/img/ILLA Builder.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>ILLA Builder</h2>
                    ...
                    <ul>
                      <a href="../halo"><li> <img src="./images/img/Halo.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Halo</h2>
                      ...
                      <a href="../wordpress"><li> <img src="./images/img/WordPress.svg" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>WordPress</h2>
                      ...
                      <a href="../flarum"><li> <img src="./images/img/Flarum.png" class="list-gijtitleico">
                        <div class="list-gij-title">
                          <div class="title-top">
                            <h2>Flarum</h2>
