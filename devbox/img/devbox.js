  ...
  buttonConfigs.forEach((config) => {
    ...
    if (config.topRange) {
      ...
      if (vw < minViewWidth) {
        ...
        newTop =
          config.topRange[0] +
          ((config.topRange[1] - config.topRange[0]) * (vw - minViewWidth)) /
            (maxViewWidth - minViewWidth);
      }
    ...
    if (config.leftRange) {
      ...
      if (vw < minViewWidth) {
        ...
        newLeft =
          config.leftRange[0] +
          ((config.leftRange[1] - config.leftRange[0]) * (vw - minViewWidth)) /
            (maxViewWidth - minViewWidth);
      }
    ...
    if (config.widthRange) {
      ...
      if (vw < minViewWidth) {
        ...
        newWidth =
          config.widthRange[0] +
          ((config.widthRange[1] - config.widthRange[0]) * (vw - minViewWidth)) /
            (maxViewWidth - minViewWidth);
      }
    ...
    if (config.heightRange) {
      ...
      if (vw < minViewWidth) {
        ...
        newHeight =
          ...
          ((config.heightRange[1] - config.heightRange[0]) * (vw - minViewWidth)) /
            (maxViewWidth - minViewWidth);
      }
