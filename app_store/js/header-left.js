document.addEventListener('DOMContentLoaded', function () {
  const navbarHtml = `<nav class="sidebar">
    <ul class="nav-list">
        <li class="nav-item" data-page="tool"> <a href="#" class="nav-link"> <i class="icon briefcase"></i> <span
                    class="link-text">常用工具</span> </a>
            <ul class="sub-menu">
                ...
                <li data-page="excalidraw"><a href="/app_store/tool/excalidraw">
                        <div class="sub-menu-lef"> <span class="dot blossom-color"></span>
                            <p>Excalidraw<span class="sub-muen-desctie">-白板手绘工具</span></p>
                        </div>
                    </a>
                </li>
        ...
        <li class="nav-item" data-page="devetool"> <a href="#" class="nav-link"> <i class="icon briefcase-3"></i> <span
                    class="link-text">开发工具</span> </a>
            <ul class="sub-menu">
                <li data-page="ubuntu"><a href="/app_store/devetool/ubuntu">
                        <div class="sub-menu-lef"> <span class="dot code-color"></span>
                            <p>Ubuntu <span class="sub-muen-desctie">- Linux发行版操作系统</span></p>
                        </div>
                    </a>
                </li>
                <li data-page="headscale"><a href="/app_store/devetool/headscale">
                        <div class="sub-menu-lef"> <span class="dot Headscale-color"></span>
                            <p>Headscale <span class="sub-muen-desctie">- 构建 WireGuard 网络</span></p>
                        </div>
                    </a>
                </li>
                <li data-page="kuboard"><a href="/app_store/devetool/kuboard">
                        <div class="sub-menu-lef"> <span class="dot kuboard-color"></span>
                            <p>kuboard <span class="sub-muen-desctie">- Kubernetes管理界面</span></p>
                        </div>
                    </a>
                </li>
                <li data-page="code-server"><a href="/app_store/devetool/code-server">
                        <div class="sub-menu-lef"> <span class="dot code-color"></span>
                            <p>code-server <span class="sub-muen-desctie">- VS-Code</span></p>
                        </div>
                    </a>
                </li>
                <li data-page="frp"><a href="/app_store/devetool/frp">
                        <div class="sub-menu-lef"> <span class="dot blossom-color"></span>
                            <p>Frp<span class="sub-muen-desctie">-反向代理工具</span></p>
                        </div>
                    </a>
                </li>
                <li data-page="nexus"><a href="/app_store/devetool/nexus">
                        <div class="sub-menu-lef"> <span class="dot code-color"></span>
                            <p>Nexus <span class="sub-muen-desctie">- Maven库管理器</span></p>
                        </div>
                    </a>
                </li>
                <li data-page="phpmyadmin"><a href="/app_store/devetool/phpmyadmin">
                        <div class="sub-menu-lef"> <span class="dot blossom-color"></span>
                            <p>phpmyadmin<span class="sub-muen-desctie">-MySQL客户端软件</span></p>
                        </div>
                    </a>
                </li>
         ...
         <li class="nav-item" data-page="AI"> <a href="#" class="nav-link"> <i class="icon briefcase-1"></i> <span
                    class="link-text">AI</span> </a>
            <ul class="sub-menu">
