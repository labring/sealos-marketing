  ...
  [11],
  {
    6301: function (e, t, s) {
      ...
      var o = Object.create,
        ...
        u = (e, t, s) =>
          t in e
            ? a(e, t, { enumerable: !0, configurable: !0, writable: !0, value: s })
            : (e[t] = s),
        c = (e, t, s, r) => {
          if ((t && 'object' == typeof t) || 'function' == typeof t)
            for (let i of l(t))
              d.call(e, i) ||
                i === s ||
                a(e, i, { get: () => t[i], enumerable: !(r = h(t, i)) || r.enumerable });
          return e;
        },
        y = (e, t, s) => (u(e, 'symbol' != typeof t ? t + '' : t, s), s),
        f = {};
      (((e, t) => {
        for (var s in t) a(e, s, { get: t[s], enumerable: !0 });
      })(f, { default: () => w }),
        (e.exports = c(a({}, '__esModule', { value: !0 }), f)));
      var E =
          ((n = null != (r = s(9893)) ? o(p(r)) : {}),
          c(!i && r && r.__esModule ? n : a(n, 'default', { value: r, enumerable: !0 }), r)),
        m = s(6129),
        v = s(2166);
      let P = 'undefined' != typeof navigator,
        g = P && 'MacIntel' === navigator.platform && navigator.maxTouchPoints > 1,
        b = P && (/iPad|iPhone|iPod/.test(navigator.userAgent) || g) && !window.MSStream,
        L = P && /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && !window.MSStream,
        S = /www\.dropbox\.com\/.+/,
        k = /https:\/\/watch\.cloudflarestream\.com\/([a-z0-9]+)/;
      class w extends E.Component {
        constructor() {
          (super(...arguments),
            y(this, 'onReady', (...e) => this.props.onReady(...e)),
            y(this, 'onPlay', (...e) => this.props.onPlay(...e)),
            y(this, 'onBuffer', (...e) => this.props.onBuffer(...e)),
            y(this, 'onBufferEnd', (...e) => this.props.onBufferEnd(...e)),
            y(this, 'onPause', (...e) => this.props.onPause(...e)),
            y(this, 'onEnded', (...e) => this.props.onEnded(...e)),
            y(this, 'onError', (...e) => this.props.onError(...e)),
            y(this, 'onPlayBackRateChange', (e) =>
              this.props.onPlaybackRateChange(e.target.playbackRate)
            ),
            y(this, 'onEnablePIP', (...e) => this.props.onEnablePIP(...e)),
            y(this, 'onDisablePIP', (e) => {
              let { onDisablePIP: t, playing: s } = this.props;
              (t(e), s && this.play());
            }),
            y(this, 'onPresentationModeChange', (e) => {
              if (this.player && (0, m.supportsWebKitPresentationMode)(this.player)) {
                let { webkitPresentationMode: t } = this.player;
                'picture-in-picture' === t
                  ? this.onEnablePIP(e)
                  : 'inline' === t && this.onDisablePIP(e);
              }
            }),
            y(this, 'onSeek', (e) => {
            ...
            y(this, 'renderSourceElement', (e, t) =>
              'string' == typeof e
                ? E.default.createElement('source', { key: t, src: e })
                : E.default.createElement('source', { key: t, ...e })
            ),
            y(this, 'renderTrack', (e, t) => E.default.createElement('track', { key: t, ...e })),
            y(this, 'ref', (e) => {
        ...
        componentDidMount() {
          ...
          (e && (this.player.src = e),
            (b || this.props.config.forceDisableHls) && this.player.load());
        }
        componentDidUpdate(e) {
          (this.shouldUseAudio(this.props) !== this.shouldUseAudio(e) &&
            ...
            this.props.url === e.url ||
              (0, m.isMediaStream)(this.props.url) ||
        ...
        addListeners(e) {
          let { url: t, playsinline: s } = this.props;
        ...
        shouldUseHLS(e) {
          return (
            (!!L && !!this.props.config.forceSafariHLS) ||
            !!this.props.config.forceHLS ||
            (!b && !this.props.config.forceDisableHls && (v.HLS_EXTENSIONS.test(e) || k.test(e)))
          );
        }
        shouldUseDASH(e) {
        ...
        load(e) {
          let { hlsVersion: t, hlsOptions: s, dashVersion: r, flvVersion: i } = this.props.config;
          if (
            (this.hls && this.hls.destroy(),
            this.dash && this.dash.reset(),
            this.shouldUseHLS(e) &&
              (0, m.getSDK)(
                'https://cdn.jsdelivr.net/npm/hls.js@VERSION/dist/hls.min.js'.replace('VERSION', t),
                'Hls'
              ).then((t) => {
                if (
                  ((this.hls = new t(s)),
                  this.hls.on(t.Events.MANIFEST_PARSED, () => {
                    this.props.onReady();
                  }),
                  this.hls.on(t.Events.ERROR, (e, s) => {
                    this.props.onError(e, s, this.hls, t);
                  }),
                  k.test(e))
                ) {
                  let t = e.match(k)[1];
                  this.hls.loadSource(
                    'https://videodelivery.net/{id}/manifest/video.m3u8'.replace('{id}', t)
                  );
            ...
            this.shouldUseDASH(e) &&
              (0, m.getSDK)(
                ...
                ((this.dash = t.MediaPlayer().create()),
                  this.dash.initialize(this.player, e, this.props.playing),
                  this.dash.on('error', this.props.onError),
                  3 > parseInt(r)
                    ? this.dash.getDebug().setLogToBrowserConsole(!1)
                    : this.dash.updateSettings({ debug: { logLevel: t.Debug.LOG_LEVEL_NONE } }),
                  this.props.onLoaded());
              }),
            this.shouldUseFLV(e) &&
              (0, m.getSDK)(
                'https://cdn.jsdelivr.net/npm/flv.js@VERSION/dist/flv.min.js'.replace('VERSION', i),
                'flvjs'
              ).then((t) => {
                ((this.flv = t.createPlayer({ type: 'flv', url: e })),
                  this.flv.attachMediaElement(this.player),
                  this.flv.on(t.Events.ERROR, (e, s) => {
                    this.props.onError(e, s, this.flv, t);
                  }),
                  this.flv.load(),
                  this.props.onLoaded());
              }),
        ...
        enablePIP() {
          this.player.requestPictureInPicture && document.pictureInPictureElement !== this.player
            ...
            : (0, m.supportsWebKitPresentationMode)(this.player) &&
        ...
        getSource(e) {
          let t = this.shouldUseHLS(e),
            s = this.shouldUseDASH(e),
            r = this.shouldUseFLV(e);
          return e instanceof Array || (0, m.isMediaStream)(e) || t || s || r
            ? void 0
            : S.test(e)
        ...
        render() {
          let {
            ...
            h = this.shouldUseAudio(this.props);
          return E.default.createElement(
            h ? 'audio' : 'video',
            {
              ref: this.ref,
              src: this.getSource(e),
              style: { width: 'auto' === o ? o : '100%', height: 'auto' === a ? a : '100%' },
              preload: 'auto',
              autoPlay: t || void 0,
              controls: r,
              muted: i,
      ...
      (y(w, 'displayName', 'FilePlayer'), y(w, 'canPlay', v.canPlay.file));
    }
  }
]);
