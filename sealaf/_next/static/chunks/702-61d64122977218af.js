  ...
  [702],
  {
    ...
    9446: function (e, t, r) {
      ...
      let w = o.default.forwardRef(function (e, t) {
        ...
        let j = o.default.useContext(f.RouterContext),
          T = o.default.useContext(h.AppRouterContext),
          _ = null != j ? j : T,
          U = !j,
          I = !1 !== S,
          B = null === S ? m.PrefetchKind.AUTO : m.PrefetchKind.FULL,
          { href: $, as: M } = o.default.useMemo(() => {
            if (!j) {
              let e = v(l);
              return { href: e, as: y ? v(y) : e };
            }
            let [e, t] = (0, s.resolveHref)(j, l, !0);
            return { href: e, as: y ? (0, s.resolveHref)(j, y) : t || e };
          }, [j, l, y]),
          D = o.default.useRef($),
          F = o.default.useRef(M);
        A && (n = o.default.Children.only(r));
        let z = A ? n && 'object' == typeof n && n.ref : t,
          [V, q, K] = (0, p.useIntersection)({ rootMargin: '200px' }),
          H = o.default.useCallback(
            (e) => {
              ((F.current !== M || D.current !== $) && (K(), (F.current = M), (D.current = $)),
                V(e),
        ...
        o.default.useEffect(() => {
          _ && q && I && b(_, $, M, { locale: k }, { kind: B }, U);
        }, [M, $, q, k, I, null == j ? void 0 : j.locale, _, U, B]);
        let W = {
          ref: H,
          onClick(e) {
          ...
          onMouseEnter(e) {
            (A || 'function' != typeof L || L(e),
              ...
              _ &&
                (I || !U) &&
                b(_, $, M, { locale: k, priority: !0, bypassPrefetchedCheck: !0 }, { kind: B }, U));
          },
        ...
        if ((0, u.isAbsoluteUrl)(M)) W.href = M;
        else if (!A || x || ('a' === n.type && !('href' in n.props))) {
          let e = void 0 !== k ? k : null == j ? void 0 : j.locale,
            t =
          ...
          W.href =
            t || (0, g.addBasePath)((0, c.addLocale)(M, e, null == j ? void 0 : j.defaultLocale));
        }
        return A ? o.default.cloneElement(n, W) : (0, i.jsx)('a', { ...P, ...W, children: r });
      });
      ('function' == typeof t.default || ('object' == typeof t.default && null !== t.default)) &&
        void 0 === t.default.__esModule &&
        (Object.defineProperty(t.default, '__esModule', { value: !0 }),
              ...
              ((t.Buffer = a),
                ...
                (a.concat = function (e, t) {
                  ...
                  for (r = 0; r < e.length; ++r) {
                    var o = e[r];
                    if ((N(o, Uint8Array) && (o = a.from(o)), !a.isBuffer(o)))
                      throw TypeError('"list" argument must be an Array of Buffers');
                ...
                (a.prototype.compare = function (e, t, r, n, i) {
                  if ((N(e, Uint8Array) && (e = a.from(e, e.offset, e.byteLength)), !a.isBuffer(e)))
                    throw TypeError(
                ...
                (a.prototype.write = function (e, t, r, n) {
                  ...
                  for (var y = !1; ; )
                    switch (n) {
                      ...
                      case 'utf8':
                      case 'utf-8':
                        return ((l = t), (u = r), L(R(e, this.length - l), this, l, u));
                      case 'ascii':
                        return ((c = t), (f = r), L(k(e), this, c, f));
                      case 'latin1':
                      case 'binary':
                        return ((i = this), (o = e), (s = t), (a = r), L(k(o), i, s, a));
                      case 'base64':
                        return ((h = t), (p = r), L(C(e), this, h, p));
                      case 'ucs2':
                      case 'ucs-2':
                      case 'utf16le':
                      case 'utf-16le':
                  ...
                  for (
                    isNaN((t = Math.abs(t))) || t === 1 / 0
                      ...
                      : ((s = Math.floor(Math.log(t) / Math.LN2)),
                        ...
                        s + f >= 1 ? (t += h / l) : (t += h * Math.pow(2, 1 - f)),
                        t * l >= 2 && (s++, (l /= 2)),
                        s + f >= c
                          ? ((a = 0), (s = c))
                          : s + f >= 1
    ...
    9193: function (e, t, r) {
      ...
      let n = r(7283)._(r(5419)).default.createContext(null);
    },
    2684: function (e, t, r) {
      'use strict';
      (Object.defineProperty(t, '__esModule', { value: !0 }),
    ...
    8296: function (e, t, r) {
      ...
      var n = r(5419),
        [i, o] = (0, r(1581).k)({ strict: !1, name: 'ButtonGroupContext' }),
        s = r(8600),
        a = r(6200),
        l = r(7230);
      function u(e) {
        let { children: t, className: r, ...i } = e,
          o = (0, n.isValidElement)(t)
            ...
            : t,
          u = (0, a.cx)('chakra-button__icon', r);
      ...
      function f(e) {
        let {
            ...
            placement: r,
            spacing: i = '0.5rem',
            children: o = (0, l.jsx)(c.$, { color: 'currentColor', width: '1em', height: '1em' }),
            className: u,
            __css: f,
            ...h
          } = e,
          p = (0, a.cx)('chakra-button__spinner', u),
          d = 'start' === r ? 'marginEnd' : 'marginStart',
          g = (0, n.useMemo)(
            () => ({
              display: 'flex',
              alignItems: 'center',
        ...
        return (0, l.jsx)(s.m.div, { className: p, ...h, __css: g, children: o });
      }
      ...
      var h = r(8597),
        ...
        g = (0, h.G)((e, t) => {
          let r = o(),
            ...
            A = { rightIcon: b, leftIcon: y, iconSpacing: w, children: g };
          return (0, l.jsxs)(s.m.button, {
            ...
            children: [
              ...
              c
                ? v || (0, l.jsx)(s.m.span, { opacity: 0, children: (0, l.jsx)(m, { ...A }) })
                : (0, l.jsx)(m, { ...A }),
              c &&
                'end' === O &&
                (0, l.jsx)(f, {
    ...
    8198: function (e, t, r) {
      ...
      var n = r(6869),
        ...
        s = r(7230);
      function a(e) {
        let { viewBox: t = '0 0 24 24', d: r, displayName: a, defaultProps: l = {} } = e,
          u = o.Children.toArray(e.path),
          c = (0, i.G)((e, i) =>
            (0, s.jsx)(n.J, {
              ref: i,
              viewBox: t,
              ...l,
              ...e,
              children: u.length ? u : (0, s.jsx)('path', { fill: 'currentColor', d: r })
            })
          );
    ...
    5578: function (e, t, r) {
      ...
      let { toString: g } = Object.prototype,
        ...
        P = b('FileList'),
        j = b('URLSearchParams'),
        [T, _, U, I] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(b);
      ...
      let M =
          'undefined' != typeof globalThis
            ...
            : 'undefined' != typeof self
              ...
              : 'undefined' != typeof window
                ...
                : global,
        D = (e) => !S(e) && e !== M,
        F = ((i = 'undefined' != typeof Uint8Array && m(Uint8Array)), (e) => i && e instanceof i),
        z = b('HTMLFormElement'),
        V = (
          ({ hasOwnProperty: e }) =>
          (t, r) =>
        ...
        W = '0123456789',
        J = { DIGIT: W, ALPHA: H, ALPHA_DIGIT: H + H.toUpperCase() + W },
        Y = b('AsyncFunction'),
        G =
      ...
      var Z = {
        ...
        isAsyncFn: Y,
        isThenable: (e) => e && (k(e) || E(e)) && E(e.then) && E(e.catch),
        setImmediate: G,
        asap: Q
      };
      ...
      var ea = function (e, t, r) {
        ...
        function l(e) {
          ...
          if (!a && Z.isBlob(e)) throw new X('Blob is not supported. Use a Buffer instead.');
        ...
        function u(e, r, i) {
          ...
          if (e && !i && 'object' == typeof e) {
            if (Z.endsWith(r, '{}')) ((r = n ? r : r.slice(0, -2)), (e = JSON.stringify(e)));
              ...
              var u;
              if (
                (Z.isArray(e) && ((u = e), Z.isArray(u) && !u.some(en))) ||
                ...
                return (
                  ...
                  a.forEach(function (e, n) {
                    Z.isUndefined(e) ||
                      null === e ||
                      t.append(!0 === s ? eo([r], n, o) : null === s ? r : r + '[]', l(e));
                  }),
                  !1
                );
            }
          }
          return !!en(e) || (t.append(eo(i, r, o), l(e)), !1);
        }
        let c = [],
          f = Object.assign(es, { defaultVisitor: u, convertValue: l, isVisitable: en });
        ...
        return (
          !(function e(r, n) {
            if (!Z.isUndefined(r)) {
              ...
              (c.push(r),
                Z.forEach(r, function (r, o) {
                  !0 ===
                    (!(Z.isUndefined(r) || null === r) &&
                      i.call(t, r, Z.isString(o) ? o.trim() : o, n, f)) &&
                    e(r, n ? n.concat(o) : [o]);
                }),
                c.pop());
            }
      ...
      function eh(e, t, r) {
        ...
        let i = (r && r.encode) || ef,
          o = r && r.serialize;
        if ((n = o ? o(t, r) : Z.isURLSearchParams(t) ? t.toString() : new eu(t, r).toString(i))) {
          let t = e.indexOf('#');
      ...
      var ed = { silentJSONParsing: !0, forcedJSONParsing: !0, clarifyTimeoutError: !1 },
        eg = 'undefined' != typeof URLSearchParams ? URLSearchParams : eu,
      ...
      let eb = 'undefined' != typeof window && 'undefined' != typeof document,
        ev =
          ...
          eb && 0 > ['ReactNative', 'NativeScript', 'NS'].indexOf(o)),
        ew =
          'undefined' != typeof WorkerGlobalScope &&
          self instanceof WorkerGlobalScope &&
          'function' == typeof self.importScripts,
        eS = (eb && window.location.href) || 'http://localhost';
      var ex = {
          ...h,
          isBrowser: !0,
          classes: { URLSearchParams: eg, FormData: em, Blob: ey },
        ...
        transformRequest: [
          function (e, t) {
            ...
            let n = t.getContentType() || '',
              ...
              o = Z.isObject(e);
            if ((o && Z.isHTMLForm(e) && (e = new FormData(e)), Z.isFormData(e)))
      ...
      let eC = Symbol('internals');
      function eL(e) {
        return e && String(e).trim().toLowerCase();
      }
      function eN(e) {
        return !1 === e || null == e ? e : Z.isArray(e) ? e.map(eN) : String(e);
      }
      ...
      class ej {
        ...
        set(e, t, r) {
          ...
          let o = (e, t) => Z.forEach(e, (e, r) => i(e, r, t));
          if (Z.isPlainObject(e) || e instanceof this.constructor) o(e, t);
          else if (Z.isString(e) && (e = e.trim()) && !eA(e)) o(ek(e), t);
        ...
        clear(e) {
          ...
          for (; r--; ) {
            let i = t[r];
            (!e || eP(this, this[i], i, e, !0)) && (delete this[i], (n = !0));
          }
          return n;
        }
        normalize(e) {
        ...
        static accessor(e) {
          let t = (this[eC] = this[eC] = { accessors: {} }).accessors,
            r = this.prototype;
          function n(e) {
            let n = eL(e);
            t[n] ||
      ...
      (ej.accessor([
        ...
        Z.reduceDescriptors(ej.prototype, ({ value: e }, t) => {
      ...
      var eW = (e) => {
          ...
          if (
            ((r.headers = a = ej.from(a)),
            (r.url = eh(eq(r.baseURL, r.url), e.params, e.paramsSerializer)),
            l &&
              a.set(
                'Authorization',
                'Basic ' +
          ...
          if (
            ...
            (i && Z.isFunction(i) && (i = i(r)), i || (!1 !== i && ez(r.url)))
          ) {
            let e = o && s && eV.read(s);
            e && a.set(o, e);
          }
          ...
          function (e) {
            return new Promise(function (t, r) {
              ...
              let l = eW(e),
                ...
                { responseType: f, onUploadProgress: h, onDownloadProgress: p } = l;
              function d() {
                (s && s(),
                  a && a(),
              ...
              function m() {
                if (!g) return;
                let n = ej.from('getAllResponseHeaders' in g && g.getAllResponseHeaders());
                (eI(
                  function (e) {
                    (t(e), d());
                  },
              ...
              (g.open(l.method.toUpperCase(), l.url, !0),
                ...
                Z.isUndefined(l.withCredentials) || (g.withCredentials = !!l.withCredentials),
                f && 'json' !== f && (g.responseType = l.responseType),
                p && (([o, a] = eM(p, !0)), g.addEventListener('progress', o)),
                h &&
                  g.upload &&
                  (([i, s] = eM(h)),
                ...
                (l.cancelToken || l.signal) &&
                  ((n = (t) => {
                    g && (r(!t || t.type ? new eU(null, e, g) : t), g.abort(), (g = null));
                  }),
          ...
          let r,
            ...
            i = function (e) {
              if (!r) {
                ...
                n.abort(t instanceof X ? t : new eU(t instanceof Error ? t.message : t));
              }
            },
            o =
              t &&
            ...
            s = () => {
              e &&
                ...
                e.forEach((e) => {
                  e &&
                    (e.removeEventListener ? e.removeEventListener('abort', i) : e.unsubscribe(i));
                }),
                (e = null));
            };
      ...
      let eG = function* (e, t) {
        ...
        eQ = async function* (e, t, r) {
          for await (let n of e) yield* eG(ArrayBuffer.isView(n) ? n : await r(String(n)), t);
        },
        eZ = (e, t, r, n, i) => {
          let o;
          let s = eQ(e, t, i),
        ...
        e8 = e0 && e2(() => Z.isReadableStream(new Response('').body)),
        e6 = { stream: e8 && ((e) => e.body) };
      eX &&
        ((f = new Response()),
        ['text', 'arrayBuffer', 'blob', 'formData', 'stream'].forEach((e) => {
          e6[e] ||
            (e6[e] = Z.isFunction(f[e])
              ? (t) => t[e]()
              : (t, r) => {
          ...
          null == e
            ...
            : Z.isBlob(e)
              ...
              : Z.isSpecCompliantForm(e)
                ...
                : Z.isArrayBufferView(e) || Z.isArrayBuffer(e)
                  ? e.byteLength
        ...
        e7 = {
          ...
          fetch:
            ...
            (async (e) => {
              ...
              try {
                if (f && e3 && 'get' !== o && 'head' !== o && 0 !== (n = await e4(p, s))) {
                  let e,
                    t = new Request(i, { method: 'POST', body: s, duplex: 'half' });
                  if (
                    (Z.isFormData(s) && (e = t.headers.get('content-type')) && p.setContentType(e),
                    t.body)
                  ) {
                    let [e, r] = eD(n, eM(eF(f)));
                ...
                h = h || 'text';
                let l = await e6[Z.findKey(e6, h) || 'text'](t, e);
                return (
                  a || b(),
                  y && y(),
      ...
      var tt = (e) => {
        ...
        for (let o = 0; o < n; o++) {
          let n;
          if (((r = t = e[o]), !te(t) && void 0 === (r = e7[(n = String(t)).toLowerCase()])))
      ...
      function tn(e) {
        return (
          ...
          tt(e.adapter || eE.adapter)(e).then(
            function (t) {
              return (
                tr(e),
      ...
      class tu {
        ...
        _request(e, t) {
          ...
          let { transitional: i, paramsSerializer: o, headers: s } = (t = eH(this.defaults, t));
          (void 0 !== i &&
            ta.assertOptions(
              i,
              {
            ...
            null != o &&
              (Z.isFunction(o)
                ...
                : ta.assertOptions(o, { encode: tl.function, serialize: tl.function }, !0)),
        ...
        getUri(e) {
          return eh(eq((e = eH(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer);
        }
      }
      (Z.forEach(['delete', 'get', 'head', 'options'], function (e) {
        tu.prototype[e] = function (t, r) {
          return this.request(eH(r || {}, { method: e, url: t, data: (r || {}).data }));
        };
      }),
      ...
      let th = (function e(t) {
        ...
        return (
          Z.extend(n, tu.prototype, r, { allOwnKeys: !0 }),
      ...
      ((th.Axios = tu),
        ...
        (th.mergeConfig = eH),
        (th.AxiosHeaders = ej),
        (th.formToJSON = (e) => eO(Z.isHTMLForm(e) ? new FormData(e) : e)),
        (th.getAdapter = tt),
    ...
    5123: function (e, t, r) {
      ...
      let { slice: n, forEach: i } = [],
        ...
        a = {
          create(e, t, r, n) {
            ...
            (r && ((i.expires = new Date()), i.expires.setTime(i.expires.getTime() + 6e4 * r)),
              n && (i.domain = n),
              (document.cookie = s(e, encodeURIComponent(t), i)));
          },
          read(e) {
            let t = `${e}=`,
      ...
      var l = {
          ...
          cacheUserLanguage(e, t) {
            let { lookupCookie: r, cookieMinutes: n, cookieDomain: i, cookieOptions: o } = t;
            r && 'undefined' != typeof document && a.create(r, e, n, i, o);
          }
        },
        u = {
          name: 'querystring',
          lookup(e) {
            ...
            if ('undefined' != typeof window) {
              ...
              for (let e = 0; e < n.length; e++) {
                let i = n[e].indexOf('=');
                i > 0 && n[e].substring(0, i) === r && (t = n[e].substring(i + 1));
              }
            }
            return t;
          }
      ...
      var h = {
        ...
        cacheUserLanguage(e, t) {
          ...
          r && f() && window.localStorage.setItem(r, e);
        }
      };
      let p = null,
        d = () => {
      ...
      var g = {
          ...
          cacheUserLanguage(e, t) {
            ...
            r && d() && window.sessionStorage.setItem(r, e);
          }
        },
        m = {
          name: 'navigator',
          lookup(e) {
            ...
            if ('undefined' != typeof navigator) {
              let { languages: e, userLanguage: r, language: n } = navigator;
              if (e) for (let r = 0; r < e.length; r++) t.push(e[r]);
        ...
        y = {
          ...
          lookup(e) {
            let t,
              { htmlTag: r } = e,
              n = r || ('undefined' != typeof document ? document.documentElement : null);
        ...
        b = {
          ...
          lookup(e) {
            ...
            if (Array.isArray(r)) return r['number' == typeof t ? t : 0]?.replace('/', '');
          }
        },
        v = {
          name: 'subdomain',
          lookup(e) {
            ...
            if (r) return r['number' == typeof t ? t + 1 : 1];
          }
        };
      class w {
        constructor(e) {
        ...
        init(e) {
          ...
          ((this.services = e || { languageUtils: {} }),
            (this.options = (function (e) {
              return (
                i.call(n.call(arguments, 1), (t) => {
                  if (t) for (let r in t) void 0 === e[r] && (e[r] = t[r]);
                }),
                e
              );
            })(t, this.options || {}, {
        ...
        detect(e) {
          ...
          return (e.forEach((e) => {
            if (this.detectors[e]) {
              let r = this.detectors[e].lookup(this.options);
              (r && 'string' == typeof r && (r = [r]), r && (t = t.concat(r)));
            }
          }),
    ...
    1992: function (e, t, r) {
      ...
      class i {
        ...
        create(e) {
          return new i(this.logger, { prefix: `${this.prefix}:${e}:`, ...this.options });
        }
        clone(e) {
          return (
        ...
        for (let e = 0; e < n.length; ) {
          ...
          for (let s = e; s < n.length; ++s)
            if ((s !== e && (o += r), (o += n[s]), void 0 !== (t = i[o]))) {
              if (['string', 'number', 'boolean'].indexOf(typeof t) > -1 && s < n.length - 1)
                continue;
              e += s - e + 1;
              break;
            }
      ...
      class S extends s {
        ...
        getResource(e, t, r) {
          ...
          a || !s || 'string' != typeof r)
            ? a
            : v(this.data && this.data[e] && this.data[e][t], r, o);
        }
        addResource(e, t, r, n) {
          let i = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : { silent: !1 },
            o = void 0 !== i.keySeparator ? i.keySeparator : this.options.keySeparator,
            s = [e, t];
        ...
        addResources(e, t, r) {
          ...
          for (let n in r)
            ('string' == typeof r[n] || Array.isArray(r[n])) &&
        ...
        addResourceBundle(e, t, r, n, i) {
          let o =
              arguments.length > 5 && void 0 !== arguments[5]
                ...
                : { silent: !1, skipCopy: !1 },
            s = [e, t];
          (e.indexOf('.') > -1 && ((s = e.split('.')), (n = r), (r = t), (t = s[1])),
            this.addNamespaces(t));
          let a = h(this.data, s) || {};
      ...
      var x = {
        ...
        handle(e, t, r, n, i) {
          return (
            e.forEach((e) => {
              this.processors[e] && (t = this.processors[e].process(t, r, n, i));
            }),
            t
          );
        }
      ...
      class E extends s {
        ...
        extractFromKey(e, t) {
          ...
          let n = void 0 !== t.keySeparator ? t.keySeparator : this.options.keySeparator,
            ...
            s =
              ...
              !(function (e, t, r) {
                ((t = t || ''), (r = r || ''));
                let n = y.filter((e) => 0 > t.indexOf(e) && 0 > r.indexOf(e));
                if (0 === n.length) return !0;
                let i = b.getRegExp(`(${n.map((e) => ('?' === e ? '\\?' : e)).join('|')})`),
                  o = !i.test(e);
                if (!o) {
                  let t = e.indexOf(r);
          ...
          if (o && !s) {
            ...
            let o = e.split(r);
            ((r !== n || (r === n && this.options.ns.indexOf(o[0]) > -1)) && (i = o.shift()),
              (e = o.join(n)));
          }
        ...
        translate(e, t, r) {
          ...
          let c = this.resolve(e, t),
            ...
            y = 'string' != typeof f && 'boolean' != typeof f && 'number' != typeof f;
          if (
            m &&
            f &&
            y &&
            ...
            if (!t.returnObjects && !this.options.returnObjects) {
              ...
              let e = this.options.returnedObjectHandler
                ? this.options.returnedObjectHandler(h, f, { ...t, ns: s })
                : `key '${o} (${this.language})' returned an object instead of string.`;
              return n ? ((c.res = e), (c.usedParams = this.getUsedParamsDetails(t)), c) : e;
            }
            if (i) {
            ...
            let n = !1,
              ...
              m =
                ...
                t[`defaultValue${d}`] ||
                t.defaultValue;
            (!this.isValidLookup(f) && h && ((n = !0), (f = m)),
            ...
            let y =
                ...
                s
                  ? void 0
                  : f,
              b = h && m !== f && this.options.updateMissing;
            if (s || n || b) {
            ...
            ((f = this.extendTranslation(f, e, t, c, r)),
              s && f === o && this.options.appendNamespaceToMissingKey && (f = `${a}:${o}`),
              (s || n) &&
        ...
        extendTranslation(e, t, r, n, i) {
          ...
          if (this.i18nFormat && this.i18nFormat.parse)
            ...
            if (
              ...
              (e = this.interpolator.interpolate(e, l, r.lng || this.language || n.usedLng, r)),
              a)
            ) {
              let t = e.match(this.interpolator.nestingRegexp);
              s < (t && t.length) && (r.nest = !1);
            }
            (!r.lng &&
              'v1' !== this.options.compatibilityAPI &&
              n &&
          ...
          return (
            ...
            e.forEach((e) => {
              ...
              let c = void 0 !== s.count && 'string' != typeof s.count,
                f = c && !s.ordinal && 0 === s.count && this.pluralResolver.shouldUseIntlApi(),
                h =
                  void 0 !== s.context &&
              ...
              u.forEach((e) => {
                this.isValidLookup(t) ||
                  ...
                  p.forEach((r) => {
                    ...
                    for (; (o = a.pop()); )
                      this.isValidLookup(t) || ((n = o), (t = this.getResource(r, e, o, s)));
                  }));
              });
            }),
            ...
            return (
              this.options.lowerCaseLng
                ...
                : 2 === r.length
                  ? ((r[0] = r[0].toLowerCase()),
                    (r[1] = r[1].toUpperCase()),
                    t.indexOf(r[1].toLowerCase()) > -1 && (r[1] = R(r[1].toLowerCase())))
                  : 3 === r.length &&
                    ((r[0] = r[0].toLowerCase()),
                    2 === r[1].length && (r[1] = r[1].toUpperCase()),
                    'sgn' !== r[0] && 2 === r[2].length && (r[2] = r[2].toUpperCase()),
                    t.indexOf(r[1].toLowerCase()) > -1 && (r[1] = R(r[1].toLowerCase())),
                    t.indexOf(r[2].toLowerCase()) > -1 && (r[2] = R(r[2].toLowerCase()))),
              r.join('-')
            );
          }
      ...
      class j {
        constructor(e) {
          ...
          ((this.languageUtils = e),
            ...
            (!this.options.compatibilityJSON || A.includes(this.options.compatibilityJSON)) &&
            ...
            (this.rules = (function () {
              ...
              return (
                C.forEach((t) => {
                  t.lngs.forEach((r) => {
                    e[r] = { numbers: t.nr, plurals: L[t.fc] };
                  });
                }),
                e
              );
      ...
      function T(e, t, r) {
        ...
        return (
          !o && i && 'string' == typeof r && void 0 === (o = v(e, r, n)) && (o = v(t, r, n)),
          o
        );
      }
      class _ {
        ...
        init() {
          ...
          ((this.escape = void 0 !== t ? t : g),
            ...
            (this.nestingPrefix = f ? p(f) : h || p('$t(')),
            (this.nestingSuffix = d ? p(d) : m || p(')')),
        ...
        interpolate(e, t, r, n) {
          ...
          let c = (e) => {
            if (0 > e.indexOf(this.formatSeparator)) {
              let i = T(t, a, e, this.options.keySeparator, this.options.ignoreJSONStructure);
            ...
            return this.format(
              T(t, a, o, this.options.keySeparator, this.options.ignoreJSONStructure),
              s,
              r,
          ...
          this.resetRegExp();
          let f = (n && n.missingInterpolationHandler) || this.options.missingInterpolationHandler,
            h =
              ...
              for (s = 0; (i = t.regex.exec(e)); ) {
                ...
                if (void 0 === (o = c(r))) {
                  if ('function' == typeof f) {
                    let t = f(e, i, n);
                    o = 'string' == typeof t ? t : '';
                  } else if (n && Object.prototype.hasOwnProperty.call(n, r)) o = '';
                  else if (h) {
                    o = i[0];
                    continue;
                  } else
                    (this.logger.warn(`missed to pass in variable ${r} for interpolating ${e}`),
                      (o = ''));
        ...
        nest(e, t) {
          ...
          for (; (r = this.nestingRegexp.exec(e)); ) {
            ...
            if ((n = t(s.call(this, r[1].trim(), i), i)) && r[0] === e && 'string' != typeof n)
              return n;
            ('string' != typeof n && (n = l(n)),
              n || (this.logger.warn(`missed to resolve ${r[1]} for nesting ${e}`), (n = '')),
              u &&
                (n = a.reduce(
                  (e, t) => this.format(e, t, o.lng, { ...o, interpolationkey: r[1].trim() }),
                  n.trim()
                )),
              (e = e.replace(r[0], n)),
        ...
        format(e, t, r) {
          ...
          return t.split(this.formatSeparator).reduce((e, t) => {
            ...
            if (this.formats[i]) {
              let t = e;
              try {
                let s = (n && n.formatParams && n.formatParams[n.interpolationkey]) || {},
      ...
      class B extends s {
        ...
        loaded(e, t, r) {
          ...
          (this.queue.forEach((r) => {
            ((function (e, t, r, n) {
              ...
              void 0 !== r.pending[e] && (delete r.pending[e], r.pendingCount--),
              t && r.errors.push(t),
              0 !== r.pendingCount ||
                r.done ||
        ...
        read(e, t, r) {
          ...
          if (this.readingCalls >= this.maxParallelReads) {
            this.waitingReads.push({ lng: e, ns: t, fcName: r, tried: n, wait: i, callback: o });
            return;
          }
          this.readingCalls++;
          let s = (s, a) => {
          ...
          if (2 === a.length) {
            try {
              let r = a(e, t);
              r && 'function' == typeof r.then ? r.then((e) => s(null, e)).catch(s) : s(null, r);
            } catch (e) {
              s(e);
            }
            return;
        ...
        loadOne(e) {
          ...
          this.read(n, i, 'read', void 0, void 0, (r, o) => {
            (r && this.logger.warn(`${t}loading namespace ${i} for language ${n} failed`, r),
              !r && o && this.logger.log(`${t}loaded namespace ${i} for language ${n}`, o),
              this.loaded(e, r, o));
          });
        }
      ...
      class F extends s {
        ...
        changeLanguage(e, t) {
          ...
          let i = (e) => {
            ...
            s = (t) => {
              ...
              let r =
                'string' == typeof t ? t : this.services.languageUtils.getBestMatchFromCodes(t);
              (r &&
                (this.language || i(r),
        ...
        getFixedT(e, t, r) {
          ...
          let i = function (e, t) {
            ...
            ((o.lng = o.lng || i.lng),
              ...
              (o.ns = o.ns || i.ns),
              '' !== o.keyPrefix && (o.keyPrefix = o.keyPrefix || r || i.keyPrefix));
        ...
        loadLanguages(e, t) {
          ...
          let n = this.options.preload || [],
            i = e.filter((e) => 0 > n.indexOf(e) && this.services.languageUtils.isSupportedCode(e));
          return i.length
        ...
        cloneInstance() {
          ...
          return (
            ...
            r && ((i.store = new S(this.store.data, n)), (i.services.resourceStore = i.store)),
            (i.translator = new E(i.services, n)),
      ...
      let z = F.createInstance();
      ((z.createInstance = F.createInstance),
        z.createInstance,
        z.dir,
        z.init,
        z.loadResources,
    ...
    2501: function (e, t, r) {
       ...
       */ var n,
        i = function (e, t) {
          ...
          for (var r = {}, n = (t || {}).decode || l, i = 0; i < e.length; ) {
            var o = e.indexOf('=', i);
            if (-1 === o) break;
            var s = e.indexOf(';', i);
            if (-1 === s) s = e.length;
        ...
        o = function (e, t, r) {
          ...
          if (n.expires) {
            var f = n.expires;
            if (('[object Date]' !== s.call(f) && !(f instanceof Date)) || isNaN(f.valueOf()))
              throw TypeError('option expires is invalid');
      ...
      class f {
        constructor(e, t = {}) {
          ...
          ((this.changeListeners = []),
            ...
            (this.update = () => {
              ...
              let e = this.cookies;
              ((this.cookies = i(document.cookie)), this._checkChanges(e));
            }));
          let n = 'undefined' == typeof document ? '' : document.cookie;
          ((this.cookies =
            'string' == typeof (r = e || n) ? i(r) : 'object' == typeof r && null !== r ? r : {}),
        ...
        set(e, t, r) {
          ...
          ((this.cookies = Object.assign(Object.assign({}, this.cookies), { [e]: n })),
      ...
      var h = r(5419);
      let p = h.createContext(new f()),
        { Provider: d, Consumer: g } = p;
      ...
      function w(e, t) {
        ...
        return (
          ...
          [
            i,
            (0, h.useMemo)(() => r.set.bind(r), [r]),
            (0, h.useMemo)(() => r.remove.bind(r), [r]),
            (0, h.useMemo)(() => r.update.bind(r), [r])
          ]
        );
      }
      ((v[b.ForwardRef] = {
    ...
    4673: function (e, t, r) {
      ...
      var i = r(5419);
      (r(3e3), Object.create(null));
      let o = (...e) => {
          console?.warn && (h(e[0]) && (e[0] = `react-i18next:: ${e[0]}`), console.warn(...e));
        },
        s = {},
        a = (...e) => {
          (h(e[0]) && s[e[0]]) || (h(e[0]) && (s[e[0]] = new Date()), o(...e));
        },
        l = (e, t) => () => {
      ...
      let R = (e, t) => {
        ...
        k = (e, t, r, n) => e.getFixedT(t, r, n),
        C = (e, t, r, n) => (0, i.useCallback)(k(e, t, r, n), [e, t, r, n]),
        L = (e, t = {}) => {
          let { i18n: r } = t,
            { i18n: n, defaultNS: o } = (0, i.useContext)(O) || {},
            s = r || n || S();
          if ((s && !s.reportNamespaces && (s.reportNamespaces = new E()), !s)) {
            a('You will need to pass in an i18next instance by using initReactI18next');
            let e = (e, t) =>
                h(t)
                  ? t
                  : p(t) && h(t.defaultValue)
                    ? t.defaultValue
                    : Array.isArray(e)
                      ? e[e.length - 1]
                      : e,
          ...
          let l = { ...v(), ...s.options.react, ...t },
            { useSuspense: d, keyPrefix: g } = l,
            m = e || o || s.options?.defaultNS;
          ((m = h(m) ? [m] : m || ['translation']), s.reportNamespaces.addUsedNamespaces?.(m));
          let y = (s.isInitialized || s.initializedStoreOnce) && m.every((e) => f(e, s, l)),
            b = C(s, t.lng || null, 'fallback' === l.nsMode ? m : m[0], g),
            w = () => b,
            x = () => k(s, t.lng || null, 'fallback' === l.nsMode ? m : m[0], g),
            [L, N] = (0, i.useState)(w),
            A = m.join();
          t.lng && (A = `${t.lng}${A}`);
          let P = R(A),
          ...
          let T = [L, s, y];
          if (((T.t = L), (T.i18n = s), (T.ready = y), y || (!y && !d))) return T;
          throw new Promise((e) => {
            t.lng ? c(s, t.lng, m, () => e()) : u(s, m, () => e());
          });
        };
    }
  }
